...
class LobbyClient:
            ...
            while self.current_room:
                ...
                if need_redraw:
                    ...
                    if room_status == "playing":
                        ...
                        print("請選擇 (房間狀態自動更新中): ", end='', flush=True)
    ...
    def _launch_game_client(self, room_data, auto_start=True):
        ...
        # ⭐ 使用伺服器回傳的 server_host，如果沒有才用 self.host
